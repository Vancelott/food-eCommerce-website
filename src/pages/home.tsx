  ...
  return (
    <div className="flex flex-col justify-center items-center mb-20">
      <div className="flex flex-col justify-center bg-gray-900 px-80 w-screen h-4/5 py-32">
        <h1 className="text-left text-4xl font-bold font-serif text-white ml-20 px-52">Our values</h1>
        <h2 className="text-left mt-12 text-lg text-white m-20 px-52 text-xl box-content">
    ...
    <div className="bg-gray-300 w-screen h-4/5 pb-56 justify-center items-center">
      <h3 className="text-center mt-16 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl">Our latest additions</h3>
        <Products />
      </div>
    </div>
  );
