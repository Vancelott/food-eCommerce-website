...
export const Home = () => {
  return (
    ...
    <div className="flex flex-col justify-center bg-gray-900 px-8 md:px-20 lg:px-40 xl:px-60 2xl:px-80 w-full h-auto py-12 md:py-24 lg:py-32">
        <h1 className="text-left text-3xl lg:text-4xl xl:text-5xl font-bold font-serif text-white ml-4 md:ml-10 xl:ml-20 2xl:ml-52 mb-6 md:mb-10">Our values</h1>
      ...
      <div className="bg-gray-100 w-full min-h-screen flex flex-col justify-center items-center pt-12 md:pt-24 lg:pt-32">
      ...
      <div className="flex flex-col items-center max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <Products/>
  </div>
  </div>
    </div>
